...
// Everything here is regenerable: a schema bump drops the tables and the app
// refetches (fallbackToDestructiveMigration). The planned trip goes with them,
// and the driver plans again.
@Database(
    entities = [
        ChargeSiteEntity::class,
        TileCoverageEntity::class,
        CorridorCoverageEntity::class,
        NetworkEntity::class,
...
abstract class ChargeSiteDatabase : RoomDatabase() {
    ...
    abstract fun plannedTrip(): PlannedTripDao
}
